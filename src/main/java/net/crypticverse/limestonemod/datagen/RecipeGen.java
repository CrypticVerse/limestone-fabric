...
public class RecipeGen extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, LimestoneBlocks.POLISHED_LIMESTONE ,4).pattern("LL ").pattern("LL ").input('L', LimestoneBlocks.LIMESTONE_BLOCK).criterion(hasItem(LimestoneBlocks.LIMESTONE_BLOCK), conditionsFromItem(LimestoneBlocks.LIMESTONE_BLOCK)).offerTo(exporter, new Identifier(getRecipeName(LimestoneBlocks.POLISHED_LIMESTONE)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, LimestoneBlocks.LIMESTONE_BRICKS ,4).pattern("LL ").pattern("LL ").input('L', LimestoneBlocks.POLISHED_LIMESTONE).criterion(hasItem(LimestoneBlocks.POLISHED_LIMESTONE), conditionsFromItem(LimestoneBlocks.POLISHED_LIMESTONE)).offerTo(exporter, new Identifier(getRecipeName(LimestoneBlocks.LIMESTONE_BRICKS)));
    }
